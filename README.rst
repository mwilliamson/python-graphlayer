...
NOTE: I'm having a runtime issue (that is probably related to my env setup; I rarely touch python), but I thought I'd tell you about it. I created a file `ex.py` with the code above and executed with `python ex.py`.
