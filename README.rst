...
NOTE: I'm getting a sytax error (I rarely touch python, btw, so it's probably me), but I thought I'd tell you about it. I created a file, ex.py, 
with the code above and executed with python ex.py.
